...
export default function SignupScreen() {
  ...
  const handleSignup = () => {
    // Signup functionality would go here. Use BetterAuth for authentication with MONGODB Adapter
    // ### mongo ###### mongo ###
    ...
    <ScrollView className="flex-1 bg-[#fef7f2]">
      <View className="flex-1 justify-center px-6 py-8">
        ...
        <View className="items-center mb-8">
          ...
          <Text className="text-3xl font-bold text-[#1f2937] mb-2">Join DinDin</Text>
          <Text className="text-[#9ca3af] text-base">Create an account to start your food journey</Text>
        </View>

        {/* Signup Form */}
        <View className="mb-8">
          <View className="mb-6">
            <Text className="text-[#1f2937] text-lg font-medium mb-2">Full Name</Text>
          ...
          <View className="mb-8">
            <Text className="text-[#1f2937] text-lg font-medium mb-2">Confirm Password</Text>
            <View className="flex-row items-center bg-white rounded-xl px-4 py-3 border border-[#e5e7eb]">
              <Lock color="#9ca3af" size={20} />
              <TextInput
                className="flex-1 ml-3 text-[#1f2937] text-base"
          ...
          <TouchableOpacity className="flex-row items-center justify-center bg-white rounded-xl py-4 border border-[#e5e7eb] mb-8">
            ...
            />
            <Text className="text-[#1f2937] text-lg font-medium">Sign up with Google</Text>
          </TouchableOpacity>
        </View>
        ...
        <View className="flex-row justify-center">
          ...
          <TouchableOpacity>
            <Text className="text-[#f97316] text-base font-bold">Sign In</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ScrollView>
