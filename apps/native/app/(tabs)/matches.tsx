          ...
          {data?.matches && data.matches.length > 0 ? (
            <>
              <Text className="text-gray-600 mb-4">
                {data.total} {data.total === 1 ? 'recipe' : 'recipes'} you both love
              </Text>
                  ...
                  {match.status === 'scheduled' && match.cookDate && (
                    <View className="bg-blue-50 px-3 py-2 border-t border-gray-100">
                      <Text className="text-blue-600 text-sm">
                        <Ionicons name="calendar" size={14} /> Scheduled for {formatDate(match.cookDate)}
                      </Text>
                    </View>
                  )}
            ...
            <>
              <View className="bg-white rounded-xl p-4 mb-3 shadow-sm">
                <Text className="text-lg font-semibold text-gray-800">No matches yet</Text>
