...
const addCommentSchema = z.object({
  ...
  commentType: z.enum(['comment', 'tip', 'modification', 'question', 'review']).default('comment'),
...
const getCommentsSchema = z.object({
  ...
  type: z.enum(['comment', 'tip', 'modification', 'question', 'review']).optional(),
});
...
export const commentsRouter = router({
  ...
  getCommentStats: protectedProcedure
    ...
    .query(async ({ input }) => {
      try {
        const stats = await RecipeCommentsService.getCommentStats(input.recipeId);
