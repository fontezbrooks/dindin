...
export class NotificationService {
  ...
  static async updateNotificationSettings(
    ...
    console.log(`Updated notification settings for user ${userId}:`, settings);
  }
  ...
  static async getNotificationAnalytics(
    ...
    const byPriority = result.byPriority.reduce((acc: any, priority: string) => {
    ...
    return {
      ...
      readRate: result.totalReceived > 0 ? (result.totalRead / result.totalReceived) * 100 : 0,
      byType,
      byPriority,
    };
  }
